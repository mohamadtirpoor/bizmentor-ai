...
const EXPERT_MODES: ExpertMode[] = [
  { 
    ...
    initialQuestions: [
      '🎯 محصول یا سرویس شما چیست؟',
      '👥 مشتریان هدف شما چه کسانی هستند؟',
      '💡 چه مشکلی را برای آنها حل می‌کنید؟',
      '📊 در چه مرحله‌ای هستید؟ (ایده، MVP، رشد، مقیاس‌پذیری)',
      '🎨 چه فیچرهایی دارید یا می‌خواهید اضافه کنید؟'
    ],
...
همیشه مثل یک CPO حرفه‌ای صحبت کن، از اصطلاحات تخصصی استفاده کن و پاسخ‌ها را data-driven و actionable ارائه بده.` 
  ...
  { 
    ...
    initialQuestions: [
      ...
      '👥 مخاطبان هدف شما کیستند؟ (سن، جنسیت، علایق)',
      '💰 بودجه بازاریابی شما چقدر است؟',
      '📊 در چه مرحله‌ای هستید؟ (راه‌اندازی، رشد، مقیاس‌پذیری)',
      '📣 از چه کانال‌هایی استفاده می‌کنید؟ (شبکه‌های اجتماعی، تبلیغات، SEO)'
    ],
...
مثل یک CMO استراتژیک فکر کن، همیشه ROI را در نظر بگیر و پاسخ‌ها را با داده پشتیبانی کن.` 
  ...
  { 
    ...
    initialQuestions: [
      '🎯 چه محصول یا خدماتی می‌فروشید؟',
      '👥 مشتریان شما B2B هستند یا B2C؟',
      '💰 قیمت محصول/خدمات شما چقدر است؟',
      '📊 چرخه فروش شما چقدر طول می‌کشد؟',
      '🎪 چه کانال‌های فروشی دارید؟ (آنلاین، حضوری، تلفنی)'
    ],
...
مثل یک VP Sales حرفه‌ای صحبت کن، روی Revenue و Conversion تمرکز کن و راهکارهای عملی ارائه بده.` 
  ...
  { 
    ...
    initialQuestions: [
      ...
      '📊 درآمد ماهانه/سالانه شما چقدر است؟',
      '💰 هزینه‌های اصلی شما چیست؟',
      '📈 آیا سودآور هستید یا در مرحله رشد؟',
      '🎯 اهداف مالی شما چیست؟ (سودآوری، کاهش هزینه، سرمایه‌گذاری)'
    ],
...
مثل یک CFO حرفه‌ای فکر کن، همه چیز را با اعداد پشتیبانی کن و روی سودآوری و پایداری مالی تمرکز کن.` 
  ...
  { 
    ...
    initialQuestions: [
      '👥 چند نفر در تیم شما کار می‌کنند؟',
      '🏢 فرهنگ سازمانی شما چگونه است؟',
      '📊 چه چالش‌هایی در HR دارید؟ (استخدام، نگهداشت، انگیزش)',
      '💼 چه نقش‌هایی می‌خواهید استخدام کنید؟',
      '🎯 اهداف HR شما چیست؟'
    ],
